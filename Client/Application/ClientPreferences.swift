...
extension Preferences {
    final class General {
        ...
        /// Whether or not to show passwords item in application menu in Brave
        static let showPasswordsInApplicationMenu = Option<Bool>(key: "general.show-passwords-application-menu", default: false)
